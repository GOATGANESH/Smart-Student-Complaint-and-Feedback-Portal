...
function openDetails(id) {
    ...
    if (complaint) {
        ...
        document.getElementById('modal-cat').innerText = complaint.category;
        document.getElementById('modal-desc').innerText = complaint.desc;
        document.getElementById('modal-date').innerText = complaint.date;
        document.getElementById('status-text').innerText = "Current Status: " + complaint.status;
        ...
        if (complaint.status === 'Pending') {
            ...
            adminText.innerText = "Complaint is pending. Faculty will soon solve your complaint.";
        } else if (complaint.status === 'Resolved') {
            adminBox.classList.add('resolved');
            adminText.innerText = "This issue has been resolved. Thank you for your patience.";
        } else {
